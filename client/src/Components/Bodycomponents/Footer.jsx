                ...
                <div className="container mx-auto p-6">
                    <div className="grid lg:grid-cols-4 gap-6">
                        <div className="">
                            ...
                            <h2 style={{cursor:"pointer"}} className="font-sans font-bold text-lg my-1 hover:text-orange"><PhoneIcon/> +91 9566854367</h2>
                        ...
                        <div className="">
                            ...
                            <p style={{cursor:"pointer"}} className="font-sans text-lg mt-1 hover:text-orange">Tamil Nadu</p>
